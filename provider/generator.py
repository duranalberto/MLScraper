...
def ___get_motors() -> list[Motor]:
    ...
    AZ(search_term='DK Libros', seller = Seller.amazon_mx),
    AZ(search_term='breville', seller = Seller.amazon_mx),
    AZ(search_term='iphone', seller = Seller.amazon_remates),
    AZ(search_term='iphone', seller = Seller.amazon_usa),
    AZ(search_term='DK books', seller = Seller.amazon_usa),
    ...
    return [
        ...
        ML('atlas', category=Category.deportes_jersey),
        ML('game boy', category = Category.consolas),
        #ML('nike calzado', category = Category.nike_oficial_calzado),
        #ML('nike ropa', category = Category.nike_oficial_calzado),
    ]
